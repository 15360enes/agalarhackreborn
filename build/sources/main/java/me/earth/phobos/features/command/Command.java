...
class Command
    ...
    void sendMessage ( String message , boolean notification ) {
        Command.sendSilentMessage ( Agalar.commandManager.getClientMessage ( ) + " " + "\u00a7r" + message );
        if ( notification ) {
            Agalar.notificationManager.addNotification ( message , 3000L );
        }
    }
    ...
    String getCommandPrefix ( ) {
        return Agalar.commandManager.getPrefix ( );
    }

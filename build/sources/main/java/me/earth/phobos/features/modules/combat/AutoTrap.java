...
class AutoTrap
    ...
    boolean check ( ) {
        ...
        return this.target == null || Agalar.moduleManager.isModuleEnabled ( "Freecam" ) && ! this.freecam.getValue ( ) || ! this.timer.passedMs ( this.delay.getValue ( ) ) || this.switchMode.getValue ( ) == InventoryUtil.Switch.NONE && AutoTrap.mc.player.inventory.currentItem != InventoryUtil.findHotbarBlock ( BlockObsidian.class );
    }

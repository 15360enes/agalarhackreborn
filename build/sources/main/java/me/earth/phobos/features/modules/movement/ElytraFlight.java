...
class ElytraFlight
    ...
    void onMove ( MoveEvent event ) {
        if ( this.mode.getValue ( ) == Mode.LOOK && ElytraFlight.mc.player.isElytraFlying ( ) ) {
            ElytraFlight.mc.player.motionY = 0;
            ElytraFlight.mc.player.motionX = 0;
            ElytraFlight.mc.player.motionZ = 0;
            if ( ElytraFlight.mc.player.movementInput.moveForward != 0 ) {
            ...
            if ( ElytraFlight.mc.player.movementInput.jump ) {
                ...
                ElytraFlight.mc.player.motionY = - 1 * this.vSpeed.getValue ( );
            }
            ...
            if ( ElytraFlight.mc.player.movementInput.moveStrafe != 0 && ElytraFlight.mc.player.movementInput.moveForward == 0 ) {
                ElytraFlight.mc.player.motionX = forward * (double) this.hSpeed.getValue ( ) * cos + strafe * (double) this.hSpeed.getValue ( ) * sin;
                ElytraFlight.mc.player.motionZ = forward * (double) this.hSpeed.getValue ( ) * sin - strafe * (double) this.hSpeed.getValue ( ) * cos;
            } else if ( ElytraFlight.mc.player.movementInput.moveStrafe != 0 || ElytraFlight.mc.player.movementInput.moveForward != 0 ) {
                ElytraFlight.mc.player.motionX = ( forward * (double) this.hSpeed.getValue ( ) * cos + strafe * (double) this.hSpeed.getValue ( ) * sin ) * ( Math.cos ( Math.abs ( MathUtil.degToRad ( mc.player.rotationPitch ) ) ) );
                ElytraFlight.mc.player.motionZ = ( forward * (double) this.hSpeed.getValue ( ) * sin - strafe * (double) this.hSpeed.getValue ( ) * cos ) * ( Math.cos ( Math.abs ( MathUtil.degToRad ( mc.player.rotationPitch ) ) ) );
            }
        ...
        if ( this.mode.getValue ( ) == Mode.OHARE ) {
            ...
            if ( ! ElytraFlight.mc.player.isElytraFlying ( ) ) return;
            if ( ! ElytraFlight.mc.player.movementInput.jump ) {
            ...
            if ( Agalar.speedManager.getSpeedKpH ( ) > 180.0 ) return;
    ...
    public
    void onDisable ( ) {
        if ( ElytraFlight.fullNullCheck ( ) || ElytraFlight.mc.player.capabilities.isCreativeMode ) return;

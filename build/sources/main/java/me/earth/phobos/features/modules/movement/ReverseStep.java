...
class ReverseStep
    ...
    void onUpdate ( ) {
        ...
        if ( this.mode.getValue ( ) == Mode.REWRITE ) {
            ...
            if ( ReverseStep.mc.player.fallDistance > 0.0f && ReverseStep.mc.player.fallDistance < 1.0f && this.delay == 0 && ! Agalar.moduleManager.isModuleEnabled ( "Strafe" ) && ! mc.player.isInWater ( ) ) {

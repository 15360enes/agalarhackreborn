...
class BlockTweaks
    ...
    void onPacketSend ( PacketEvent.Send event ) {
        ...
        if ( this.noFriendAttack.getValue ( ) && event.getPacket ( ) instanceof CPacketUseEntity && ( entity = ( (CPacketUseEntity) event.getPacket ( ) ).getEntityFromWorld ( BlockTweaks.mc.world ) ) != null && Agalar.friendManager.isFriend ( entity.getName ( ) ) ) {

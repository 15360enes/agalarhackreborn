...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Agalar.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : Agalar.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Agalar.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Agalar.moduleManager.getModuleByName(commands[0]);
            if (module == null) {

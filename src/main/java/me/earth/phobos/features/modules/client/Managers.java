...
public class Managers
    ...
    public Setting<Integer> betterFPS = this.register(new Setting<Object>("MaxFPS", Integer.valueOf(500), Integer.valueOf(1), Integer.valueOf(1500), v -> this.betterFrames.getValue()));
    ...
    @Override
    public void onLoad() {
        Agalar.commandManager.setClientMessage(this.getCommandMessage());
    }
        ...
        if (event.getStage() == 2) {
            ...
            if (event.getSetting() != null && this.equals(event.getSetting().getFeature())) {
                if (event.getSetting().equals(this.holeThread)) {
                    Agalar.holeManager.settingChanged();
                }
                Agalar.commandManager.setClientMessage(this.getCommandMessage());
            }
        }

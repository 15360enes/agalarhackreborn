...
public class Notifications
        extends Module {
    private static final String fileName = "agalarclient/util/ModuleMessage_List.txt";
    ...
    public void onToggleModule(ClientEvent event) {
        ...
        if (!(event.getStage() != 0 || (module = (Module) event.getFeature()).equals(this) || !modules.contains(module.getDisplayName()) && this.list.getValue().booleanValue())) {
            ...
            if (this.watermark.getValue().booleanValue()) {
                TextComponentString textComponentString = new TextComponentString(Agalar.commandManager.getClientMessage() + " " + "\u00a7f" + "\u00a7l" + module.getDisplayName() + "\u00a74" + "\u00a7l" + " disabled.");
                Notifications.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(textComponentString, moduleNumber);
            } else {
                TextComponentString textComponentString = new TextComponentString("\u00a7l" + module.getDisplayName() + "\u00a74" + "\u00a7l" + " disabled.");
                Notifications.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(textComponentString, moduleNumber);
            }
        }
        if (event.getStage() == 1 && (modules.contains((module = (Module) event.getFeature()).getDisplayName()) || !this.list.getValue().booleanValue())) {
            ...
            if (this.watermark.getValue().booleanValue()) {
                TextComponentString textComponentString = new TextComponentString(Agalar.commandManager.getClientMessage() + " " + "\u00a7f" + "\u00a7l" + module.getDisplayName() + "\u00a7a" + "\u00a7l" + " enabled.");
                Notifications.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(textComponentString, moduleNumber);
            } else {
                TextComponentString textComponentString = new TextComponentString("\u00a7l" + module.getDisplayName() + "\u00a7a" + "\u00a7l" + " enabled.");
                Notifications.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(textComponentString, moduleNumber);
            }
        }
    }

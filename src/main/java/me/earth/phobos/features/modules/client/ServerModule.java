...
public class ServerModule
    ...
    public Setting<String> serverIP = this.register(new Setting<String>("ServerIP", "AgalarHvH.eu"));
    ...
    public ServerModule() {
        super("PingBypass", "Manages Agalar`s internal Server", Module.Category.CLIENT, false, false, true);
        instance = this;
    }

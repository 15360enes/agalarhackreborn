...
public class StreamerMode
    ...
    public void onLogout() {
        if (this.window != null) {
            ...
            drawInfo.add(Agalar.MODNAME + " " + Agalar.MODVER);
            drawInfo.add("");
    ...
    public void onUpdate() {
        if (this.window != null) {
            ...
            drawInfo.add("TPS: " + Agalar.serverManager.getTPS());
            drawInfo.add("Ping: " + Agalar.serverManager.getPing() + "ms");
            drawInfo.add("Speed: " + Agalar.speedManager.getSpeedKpH() + "km/h");
            ...
            String text = Agalar.rotationManager.getDirection4D(false);
            drawInfo.add("");
            drawInfo.add(text);
            ...
            for (PotionEffect effect : Agalar.potionManager.getOwnPotions()) {
                String potionText = TextUtil.stripColor(Agalar.potionManager.getColoredPotionString(effect));

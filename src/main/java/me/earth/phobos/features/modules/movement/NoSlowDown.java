...
class NoSlowDown
    ...
    void onUpdate ( ) {
        ...
        if ( this.webs.getValue ( ) && Agalar.moduleManager.getModuleByClass ( Flight.class ).isDisabled ( ) && Agalar.moduleManager.getModuleByClass ( Phase.class ).isDisabled ( ) && NoSlowDown.mc.player.isInWeb ) {

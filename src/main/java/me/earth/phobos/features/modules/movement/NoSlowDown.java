...
public class NoSlowDown
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue().booleanValue() && Agalar.moduleManager.getModuleByClass(Flight.class).isDisabled() && Agalar.moduleManager.getModuleByClass(Phase.class).isDisabled() && NoSlowDown.mc.player.isInWeb) {

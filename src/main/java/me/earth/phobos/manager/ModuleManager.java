...
import me.earth.phobos.features.modules.combat.bowbomb;
...
public class ModuleManager
    ...
    public void init() {
        this.modules.add(new CrashExploit());
        ...
        this.moduleColorMap.put(this.getModuleByClass(CrashExploit.class), new Color(0, 0, 0));
        ...
        this.moduleColorMap.put(this.getModuleByClass(AutoMinecart.class), new Color(255,15,43));
        this.moduleColorMap.put(this.getModuleByClass(AutoWeb.class), new Color(255,15,43));
        ...
        this.moduleColorMap.put(this.getModuleByClass(AutoAgla.class), new Color(240, 49, 110));
        ...
        this.moduleColorMap.put(this.getModuleByClass(GhastNotifier.class), new Color(68, 178, 142));
        ...
        this.moduleColorMap.put(this.getModuleByClass(bowbomb.class), new Color(0, 0, 0));
        this.moduleColorMap.put(this.getModuleByClass(CrystalModifier.class), new Color(185, 75, 124));
        this.moduleColorMap.put(this.getModuleByClass(PopChams.class), new Color(185, 75, 124));
        this.moduleColorMap.put(this.getModuleByClass(PenisEsp.class), new Color(185, 75, 124));
